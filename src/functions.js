    ...
    colorLib.functions = {
        ...
        "data-uri": function(mimetypeNode, filePathNode) {
            ...
            if (typeof window !== 'undefined') {
                return new colorLib.URL(filePathNode || mimetypeNode, this.currentFileInfo).eval(this.env);
            }
            ...
            return new(colorLib.URL)(new(colorLib.Anonymous)(uri));
        }
    };
    ...
    colorLib._mime = {
        ...
        lookup: function (filepath) {
            var ext = require('path').extname(filepath),
                type = colorLib._mime._types[ext];
            if (type === undefined) {
